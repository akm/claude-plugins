...
- **採択されたものだけを直す。** 保留は人間の判断待ち、却下は直さないと決めたもの。ここで再度判断しない。誤った採択に気づいても、ここでは直さず報告する。**これは採否の判断を蒸し返さないという意味であって、同じ原因の別の現れを残す意味ではない** — 調査 (手順 4) で見つけた同じ原因の箇所は、指摘されていなくても問題に含めて直す。束ねる基準は原因であって、指摘の有無ではない ([references/grouping.md](references/grouping.md))。
