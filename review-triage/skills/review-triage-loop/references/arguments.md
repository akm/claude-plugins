...
```
review-triage-loop [--max <回数>] [--review <スキル名>] [--review-args "<引数>"] [--model <モデル>]
```
...
1. 引数にあればその値
2. 無ければ設定の `loop` の値 (「未設定」の定義の正本は [project-config.md](../../review-triage/references/project-config.md) の「「未設定」の定義」)
